...
from scvi.module import DeterministicThinnedVAE
...
class DeterministicThinnedSCVI(SCVI):
    ...
    **kwargs
        Additional keyword arguments for :class:`~scvi.module.DeterministicThinnedVAE`.

    Examples
    --------
    >>> adata = anndata.read_h5ad(path_to_anndata)
    >>> scvi.model.DeterministicThinnedSCVI.setup_anndata(adata, batch_key="batch")
    >>> model = scvi.model.DeterministicThinnedSCVI(adata, min_library_size=10.0)
    >>> model.train()
    ...
    :class:`~scvi.model.ThinnedSCVI`
    :class:`~scvi.module.DeterministicThinnedVAE`
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Pass min_library_size through kwargs to module
        super().__init__(
            adata=adata,
            n_hidden=n_hidden,
            n_latent=n_latent,
