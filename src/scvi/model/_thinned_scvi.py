...
from scvi.module import ThinnedVAE
...
class ThinnedSCVI(SCVI):
    ...
    **kwargs
        Additional keyword arguments for :class:`~scvi.module.ThinnedVAE`.

    Examples
    --------
    >>> adata = anndata.read_h5ad(path_to_anndata)
    >>> scvi.model.ThinnedSCVI.setup_anndata(adata, batch_key="batch")
    >>> model = scvi.model.ThinnedSCVI(adata, min_library_size=10.0)
    >>> model.train()
    ...
    :class:`~scvi.model.JointEmbeddingSCVI`
