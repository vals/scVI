...
from scvi.module import NonZeroVAE
...
class NonZeroSCVI(SCVI):
    ...
    **kwargs
    ...
    >>> scvi.model.NonZeroSCVI.setup_anndata(adata, batch_key="batch")
    >>> vae = scvi.model.NonZeroSCVI(adata)
    >>> vae.train()
