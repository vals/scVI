...
from scvi.module._joint_embedding_utils import binomial_split, sample_thinning_probs
    ...
    **kwargs
    ...
    def _get_inference_input(
        ...
        if loader == "minified_data":
            # Minified data path - no thinning
            return {
