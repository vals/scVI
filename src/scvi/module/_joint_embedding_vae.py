...
class JointEmbeddingVAE(VAE):
    ...
    **kwargs
    ...
    def loss(
        ...
        recon_weight = reconstruction_weight if reconstruction_weight is not None else self.reconstruction_weight
        ...
        # If joint embedding is disabled or not training, return reweighted ELBO
        ...
        # Use z from full data (already computed in forward pass)
        z_full = inference_outputs[MODULE_KEYS.Z_KEY]

        # Compute CCO loss between thinned and full embeddings
        ...
        # Apply weights
        je_weight = joint_embedding_weight if joint_embedding_weight is not None else self.joint_embedding_weight
